                            ...
                            <section class="panel" style="border: 2px solid #000; border-radius: 5px;">
                                <div class="panel-body">
                                    <div class="form-group ">
                                        ...
                                        <input class=" form-control" type="text" id="sub_title" name="sub_title" value="">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class=" form-control" type="file" id="image" name="cover" accept="image/png, image/gif, image/jpeg" onchange="previewImage(this)">
