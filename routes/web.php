...
// Link storage folder with public
// First delete the storage folder from public and call this route then the routes will be linked...
...
Route::get('/allPosts',                                    ['as' => 'customer.allPosts',              'uses' =>   'Frontend\SiteController@allPosts']);
